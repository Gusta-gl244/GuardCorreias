...
// local — hoje é uma correspondência direta (mesmo nome dos dois lados),
// mas mantido como tabela por causa do restante do motor (drainOutbox/pull
// abaixo), que foi escrito genérico o bastante para não precisar mudar se
// algum dia os nomes divergirem de novo.
  ...
  try {
    ...
    for (const result of results) {
      ...
      if (mutation.op === 'delete') {
        ...
        // removido localmente na hora da ação (deleteInspectionOrder etc.), só
