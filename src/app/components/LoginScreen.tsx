...
import guardCorreiasLogo from '../../assets/brand/guardcorreias-logo.png';
    ...
    <div className="min-h-screen flex flex-col items-center justify-center relative" style={{ backgroundColor: '#193A2A' }}>
      ...
      <div className="relative w-full max-w-sm px-6">
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="p-8">
            ...
            <div className="flex items-center justify-center mb-6">
              <img src={guardCorreiasLogo} alt="GuardCorreias" className="h-28 w-auto object-contain" />
            </div>

            {/* Title */}
            <div className="text-center mb-6">
              <h1 style={{ color: '#193A2A' }} className="text-lg">Sistema de Inspeções</h1>
              <p className="text-xs text-gray-500 mt-1">Gestão de Correias Transportadoras</p>
            </div>
            ...
            {isDevMode && (
              <div className="mt-6 pt-5 border-t border-gray-100">
                ...
                <div className="space-y-1">
                  {[
                    { email: 'tecnico@guardcorreias.com', label: 'Técnico' },
                    { email: 'supervisor@guardcorreias.com', label: 'Supervisor' },
                    { email: 'admin@guardcorreias.com', label: 'Super Admin' },
                  ].map((acc) => (
                    <button
                      key={acc.email}
                      type="button"
                      onClick={() => { setEmail(acc.email); setPassword('guardcorreias'); }}
                  ...
                  <p className="text-xs text-gray-400 text-center pt-1">Senha: guardcorreias</p>
                </div>
              </div>
            )}
          </div>
        ...
        <p className="text-center text-white/30 text-[10px] mt-4">
          © 2026 GuardCorreias · Mineração Vale Verde · v{versionInfo?.version || '0.1.0'}
          {' · '}
          <button
            type="button"
            ...
            <div className="p-6">
              ...
              <div className="space-y-4 text-sm">
                <div>
                  ...
                  <p className="text-gray-700">GuardCorreias — Sistema de Inspeção e Gestão de Correias Transportadoras</p>
                </div>
